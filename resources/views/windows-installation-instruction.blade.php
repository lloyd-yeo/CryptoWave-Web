				...
				<div class="content-mini content-boxed">
					<ul class="nav nav-pills nav-sub-header push">
						...
						<li>
							...
							<a href="/download" id="download-windows-link"  class="active" target="_blank">
						...
						<div class="content">
							<div class="block block-transparent block-themed text-center">
								<div class="block-content">
									<h1 class="h1 font-w700 text-white animated fadeInDown push-5">Windows Miner
									                                                               Installer</h1>
							...
							<div class="block-content block-content-full bg-gray-lighter text-center">
								<div style="height: 2000px; overflow-x: auto;">
									<blockquote style="text-align:left;">
										<p>1. Locate the file you've downloaded, it's called "CryptoWaveMiner.zip".
											<br/>
									...
									<blockquote style="text-align:left;">
										...
										<br/>
										<span style="font-size: 12px; font-weight:bold;">If you are missing xmr-stak.exe, your anti-virus is likely blocking it.
										                                                 Double check your anti-virus software and turn it off. Go back & repeat step 3 to extract the files again</span>
										<br/>
									</blockquote>
