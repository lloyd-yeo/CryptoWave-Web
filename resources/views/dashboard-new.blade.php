        ...
        <div class="section parallax parallax-bg nomargin notopborder" data-rellax-speed="2" style="background: url('images/parallax/3.jpg') center center; padding: 100px 0;"
            ...
            <div class="container-fluid center clearfix" style="padding-top: 100px;">
                ...
                <div class="heading-block">
                    <h2 style="font-size: 64px; color:white; line-height: 70px;">WELCOME TO<br/>CRYPTOWAVE</h2>
                    <span style="color:white;">Get started choosing one of the options below:</span>
                    <div class="clear"></div>
                </div>
                ...
                <div class="col_one_third">
                    <div class="feature-box fbox-center fbox-effect">
                        ...
                        <p style="color:white; font-size: 18px;">Discover how you can use spare computer
                            resource for mining with our FREE crypto-mining software!</p>
                    </div>
                </div>
                ...
                <div class="col_one_third">
                    <div class="feature-box fbox-center fbox-effect">
                        ...
                        <p style="color:white; font-size: 18px;">Learn about the world of
                            cryptocurrencies and the polarizing blockchain technology</p>
                    </div>
                </div>
                ...
                <div class="col_one_third col_last">
                    <div class="feature-box fbox-center fbox-effect">
                        <div class="fbox-icon" style="height: 192px; width: 192px;">
                            <a href="/dashboard"><i class="icon-users i-alt"
                                                    style="font-size: 84px; line-height: 192px;"></i></a>
                        </div>
                        <h3 style="font-size: 26px; color:white;">Share</h3>
                        <p style="color:white; font-size: 18px;">Spread the word, find friends to mine
                            together with you and grow our community!</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="container clearfix">
                            <div class="slider-caption slider-caption-center">
                                ...
                                <p class="d-none d-sm-block" data-caption-animate="fadeInUp" data-caption-delay="200">
                                    Get started choosing one of the options below:</p>
                                ...
                                <div class="col_one_third col_last">
                                    <div class="feature-box fbox-center fbox-effect">
                                        <div class="fbox-icon" style="height: 192px; width: 192px;">
                                            <a href="/affiliate"><i class="icon-users i-alt"
                                                                    style="font-size: 84px; line-height: 192px;"></i></a>
                                        </div>
