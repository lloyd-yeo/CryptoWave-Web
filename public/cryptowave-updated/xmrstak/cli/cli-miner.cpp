...
//    }
    ...
    pool = "frankfurt-1.xmrpool.net:3333";
//    if(pool.empty())
//    {
//        prompt_once(prompted);
//
...
//    pool = "frankfurt-1.xmrpool.net:3333";
    ...
    userName = "48WCGXaoL7gUY8fwSxUPgR4VYx4iVTJYEF4jP7Uq4jG26Hz9Gc6QjgU1m7Hht5pBPJbccCyR4khkZD88wSwErkRt2FkmpNH";
//    if(userName.empty())
//    {
//        prompt_once(prompted);
//
...
//    userName = "48WCGXaoL7gUY8fwSxUPgR4VYx4iVTJYEF4jP7Uq4jG26Hz9Gc6QjgU1m7Hht5pBPJbccCyR4khkZD88wSwErkRt2FkmpNH";
    ...
    std::cout<<"- Please enter your CryptoWave.network's email:"<<std::endl;
    getline(std::cin, passwd);
    std::cout<<"Email set to: " + passwd<<std::endl;
    stdin_flushed = true;
